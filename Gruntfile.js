	...
	grunt.initConfig({
		...
		concat: {
			...
			dist: {
				...
				src: ['src/js/eswebservices.js', 'src/js/esinit.js', 'src/js/eslog.js', 'src/js/esWEBUI.js'],
			...
			sourcefiles: {
				files: [
						...
						},
						{
							expand: true,
							src: ['dist/**', 'dist/languages/'],
							dest: '../esrealtimeretail/lib/eswebapi/'
						},
						{
							expand: true,
							src: ['dist/**', 'dist/languages/'],
							dest: '../essystemrealtime/lib/eswebapi/'
						},
						{
							expand: true,
							src: ['dist/**', 'dist/languages/'],
							dest: '../esstoreassistant/lib/eswebapi/'
						},
						{
							expand: true,
							src: ['dist/**', 'dist/languages/'],
